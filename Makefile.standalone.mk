...
up-ep1:
	...
	@sleep 2
	@ping 31.31.31.1 -c 5
	@sudo ip netns exec ep1 ping 31.31.31.254 -c 5
...
up-ep2:
	...
	@sleep 2
	@ping 32.32.32.1 -c 5
	@sudo ip netns exec ep2 ping 32.32.32.254 -c 5
...
up-ep3:
	...
	@sleep 2
	@ping 33.33.33.1 -c 5
	@sudo ip netns exec ep3 ping 33.33.33.254 -c 5
...
up-h1:
	...
	@sleep 2
	@ping 10.10.10.1 -c 5
	@sudo ip netns exec h1 ping 10.10.10.254 -c 5
...
.PHONY: test-apply-lb
test-apply-lb:
	@loxicmd create lb 20.20.20.1 --tcp=8080:8080 --endpoints=31.31.31.1:1,32.32.32.1:1,33.33.33.1:1
